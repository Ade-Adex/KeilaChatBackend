...
// 🎯 ADDED: Direct sub-document Schema for mathematical vectors
const CrawlChunkSchema = new Schema<ICrawlChunk>({
  text: { type: String, required: true },
  embedding: { type: [Schema.Types.Number], required: true },
})
...
const CrawledSourceSchema = new Schema<ICrawledSource>(
  {
    ...
    chunks: [CrawlChunkSchema], // 🎯 NESTED CHUNKS SCHEMA LINK
  },
  {
    timestamps: true,
  },
...
const KnowledgeBaseSchema = new Schema<IKnowledgeBase>(
  {
    ...
    fallbackMessage: {
      type: String,
      default: 'Sorry, I could not find an answer...',
      trim: true,
    },
    welcomeMessage: {
      type: String,
